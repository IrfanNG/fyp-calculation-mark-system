    ...
    <div className="flex min-h-screen items-center justify-center bg-(--unikl-bg) px-4">
      <div className="w-full max-w-md space-y-4">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-(--unikl-muted)">Student Portal Login</p>
        </div>

        <form onSubmit={handleSubmit} className="rounded-lg border border-(--unikl-border) bg-(--unikl-card) p-6 space-y-4" autoComplete="off">
          {error ? (
          ...
          <div className="text-center text-sm">
            ...
            <Link href="/student/signup" className="font-medium text-(--unikl-blue) hover:underline">
              Sign up
            </Link>
          </div>
